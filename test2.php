...
SQL;
        ...
        if($resultado) {
            $linea = $resultado->fetch();
                ...
                <div class="panel panel-default"><div class="panel-heading">PLAYAS</div>';
                echo '<table class="table">';
                echo '<br><tr><th>NOMBRE </th><th>DESCRIPCIÓN </th><th>DIRECCION</th><th>TAMAÑO</th><th>LONGITUD</th><th>LATITUD</th><th>IMAGEN</th><th>EDIT</th></tr></br>';
            while ($linea != null) {
...
imagen */
        ...
        echo '<img src="data:image/jpeg;base64,'.base64_encode($imagen).'" style="width="50px; height="50px;"/>';
                echo "<td><button class='btn btn-info' type='submit' value='Editar' name='edit'>EDITAR</button></td></tr>";
